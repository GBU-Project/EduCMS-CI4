...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                <?php echo educard_start('Edit Kategori', 'edit'); ?>
                    <?php echo form_open('admin/categories/edit/' . $row->id); ?>
                        ...
                        <?php echo eduform_input(
                            'slug', 
                            'Slug URL', 
                            set_value('slug', $row->slug), 
                            'text', 
                            array('required' => TRUE, 'placeholder' => 'Slug URL')
                        ); ?>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-indigo">
                                <?php echo render_icon('circle-check', 'mr-1'); ?> Perbarui Kategori
                            </button>
