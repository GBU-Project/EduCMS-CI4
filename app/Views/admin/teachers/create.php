...
<?php echo form_open_multipart('admin/teachers/create'); ?>
<div class="row">
    <div class="col-md-8">
        <?php echo educard_start('Data Guru', 'chalkboard-user'); ?>
            <?php echo eduform_input('name', 'Nama Lengkap', set_value('name'), 'text', array('required' => TRUE, 'placeholder' => 'Nama lengkap guru')); ?>
            <?php echo eduform_input('nip', 'NIP', set_value('nip'), 'text', array('placeholder' => 'Nomor Induk Pegawai')); ?>
            <?php echo eduform_select('gender', 'Jenis Kelamin', array('L' => 'Laki-laki', 'P' => 'Perempuan'), set_value('gender', 'L'), array('required' => TRUE)); ?>
            <?php echo eduform_input('place_of_birth', 'Tempat Lahir', set_value('place_of_birth'), 'text'); ?>
            <?php echo eduform_input('date_of_birth', 'Tanggal Lahir', set_value('date_of_birth'), 'date'); ?>
            <?php echo eduform_input('position', 'Jabatan', set_value('position'), 'text', array('required' => TRUE, 'placeholder' => 'Contoh: Guru Kelas, Wali Kelas X-A')); ?>
    ...
    <div class="col-md-4">
        <?php echo educard_start('Status & Publikasi', 'paper-plane'); ?>
            ...
            <div class="mt-4">
                ...
                <a href="<?php echo base_url('admin/teachers'); ?>" class="btn btn-outline-secondary btn-block mt-2">Batal</a>
            </div>
        <?php echo educard_end(); ?>
        <?php echo educard_start('Foto Guru', 'image'); ?>
