...
<?php echo form_open_multipart('admin/teachers/edit/' . $row->id); ?>
<div class="row">
    <div class="col-md-8">
        <?php echo educard_start('Data Guru', 'chalkboard-user'); ?>
            ...
            <?php echo eduform_input('nip', 'NIP', set_value('nip', $row->nip ?? ''), 'text'); ?>
            ...
            <?php echo eduform_input('place_of_birth', 'Tempat Lahir', set_value('place_of_birth', $row->place_of_birth ?? ''), 'text'); ?>
            <?php echo eduform_input('date_of_birth', 'Tanggal Lahir', set_value('date_of_birth', $row->date_of_birth ?? ''), 'date'); ?>
    ...
    <div class="col-md-4">
        ...
        <?php echo educard_start('Foto Guru', 'image'); ?>
            <?php echo eduform_file('photo', 'Ganti Foto', $row->photo ?? '', array('help' => 'Kosongkan jika tidak ingin mengganti foto.')); ?>
        <?php echo educard_end(); ?>
    </div>
</div>
<?php echo form_close(); ?>
