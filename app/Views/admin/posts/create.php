...
<section class="content">
    <div class="container-fluid">
        ...
        <?php echo form_open_multipart('admin/posts/create'); ?>
        <div class="row">
            <div class="col-md-8">
                ...
                <?php echo educard_start('Konten Berita', 'newspaper'); ?>
                    ...
                    <?php echo eduform_input(
                        ...
                        set_value('slug'),
                        'text',
                        array('placeholder' => 'contoh: acara-sekolah-2026 (biarkan kosong untuk auto-generate)')
                    ); ?>
            ...
            <div class="col-md-4">
                <?php echo educard_start('Publikasi', 'paper-plane'); ?>
                    ...
                    <?php echo eduform_checkbox(
                        ...
                        set_value('is_featured') ? TRUE : FALSE
                    ); ?>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-indigo btn-block">
                            <?php echo render_icon('circle-check', 'mr-1'); ?> Simpan Berita
                        </button>
                ...
                <?php echo educard_start('Gambar Utama', 'image'); ?>
                    ...
                    <?php echo eduform_file(
                        ...
                        'Featured Image',
                        '',
                        array('help' => 'Gambar utama yang tampil di daftar dan halaman berita.')
                    ); ?>
