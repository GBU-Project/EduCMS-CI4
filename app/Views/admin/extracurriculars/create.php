...
<?php echo form_open_multipart('admin/extracurriculars/create'); ?>
<div class="row">
    <div class="col-md-8">
        <?php echo educard_start('Detail Ekstrakurikuler', 'volleyball'); ?>
            <?php echo eduform_input('name', 'Nama Ekstrakurikuler', set_value('name'), 'text', array('required' => TRUE, 'placeholder' => 'Contoh: Pramuka, Futsal, Paskibra')); ?>
            <?php echo eduform_input('coach', 'Pembina', set_value('coach'), 'text', array('placeholder' => 'Nama pembina/pelatih')); ?>
            <?php echo eduform_input('schedule', 'Jadwal', set_value('schedule'), 'text', array('placeholder' => 'Contoh: Setiap Jumat, 15.00-17.00')); ?>
            <?php echo eduform_textarea('description', 'Deskripsi', set_value('description'), array('rows' => 5, 'required' => TRUE, 'placeholder' => 'Deskripsi kegiatan ekstrakurikuler...')); ?>
    ...
    <div class="col-md-4">
        ...
        <?php echo educard_start('Foto', 'image'); ?>
            <?php echo eduform_file('image', 'Upload Foto', '', array('help' => 'Foto kegiatan/logo ekstrakurikuler.')); ?>
        <?php echo educard_end(); ?>
    </div>
</div>
<?php echo form_close(); ?>
