...
<?php echo form_open('admin/menu-groups/edit/' . $row->id); ?>
<div class="row">
    <div class="col-md-8">
        <?php echo educard_start('Detail Menu', 'bars-staggered'); ?>
            <?php echo eduform_input('name', 'Nama Menu', set_value('name', $row->name ?? ''), 'text', array('required' => TRUE)); ?>
    ...
    <div class="col-md-4">
        <?php echo educard_start('Simpan', 'paper-plane'); ?>
            <button type="submit" class="btn btn-indigo btn-block"><?php echo render_icon('circle-check', 'mr-1'); ?> Perbarui Menu</button>
