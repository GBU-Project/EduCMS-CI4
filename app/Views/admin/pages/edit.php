    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <?php echo educard_start('Edit Konten Halaman', 'file-lines'); ?>
                    <?php echo form_open_multipart('admin/pages/edit/' . $page->id); ?>
                        ...
                        <?php echo eduform_input(
                            ...
                            'text', 
                            array('placeholder' => 'contoh: profil-sekolah')
                        ); ?>

                        <?php echo eduform_textarea(
                            'content', 
                            'Konten Halaman', 
                            set_value('content', $page->content, FALSE), 
            ...
            <div class="col-md-4">
                <?php echo educard_start('Metadata & Setelan', 'sliders'); ?>
                    ...
                    <?php echo eduform_file(
                        ...
                        'Gambar Banner',
                        $page->banner,
                        array('help' => 'Kosongkan jika tidak ingin mengganti gambar banner saat ini.')
                    ); ?>
                    ...
                    <?php echo eduform_select(
                        ...
                        'Template Halaman', 
                        $templates, 
                        set_value('template', $page->template)
                    ); ?>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-indigo btn-block">
                            <?php echo render_icon('circle-check', 'mr-1'); ?> Perbarui Halaman
                        </button>
