...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <?php 
                    $card_title = $show_trash ? 'Daftar Tempat Sampah Kategori' : 'Semua Kategori Berita';
                ...
                ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            ...
                            <?php else: ?>
                                <a href="<?php echo base_url('admin/categories/create'); ?>" class="btn btn-sm btn-indigo">
                                    <?php echo render_icon('plus', 'mr-1'); ?> Buat Kategori Baru
                                </a>
                                <a href="<?php echo base_url('admin/categories?trash=1'); ?>" class="btn btn-sm btn-outline-danger ml-2">
                    ...
                    <?php if (empty($list)): ?>
                        <?php echo eduempty_state(
                            'Tidak Ada Kategori',
                            $show_trash ? 'Tempat sampah kosong.' : 'Belum ada kategori berita yang dibuat.',
                            'tags',
                            $show_trash ? '' : 'Buat Kategori',
                            $show_trash ? '' : 'admin/categories/create'
                        ); ?>
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php $no = 1; foreach ($list as $item): ?>
                                        <tr>
                                            ...
                                            <td><?php echo esc_html($item->description ? $item->description : '-'); ?></td>
                                            <td class="text-right">
                                                <?php echo render_action_buttons($item->id, $item->slug, 'admin/categories', $show_trash); ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
...
<script>
    $(document).ready(function() {
        if ($('#categories-table').length) {
            EduTable.init('#categories-table');
        }
    });
</script>
