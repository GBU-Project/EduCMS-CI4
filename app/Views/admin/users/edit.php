...
<?php echo form_open('admin/users/edit/' . $row->id); ?>
<div class="row">
    <div class="col-md-7">
        <?php echo educard_start('Detail Pengguna', 'user'); ?>
            <?php echo eduform_input('full_name', 'Nama Lengkap', set_value('full_name', $row->full_name ?? ''), 'text', array('required' => TRUE)); ?>
            <?php echo eduform_input('email', 'Email', set_value('email', $row->email ?? ''), 'email', array('required' => TRUE)); ?>
            <?php echo eduform_input('password', 'Password Baru', '', 'password', array('help' => 'Kosongkan jika tidak ingin mengganti password.')); ?>
    ...
    <div class="col-md-5">
        <?php echo educard_start('Peran (Roles)', 'user-shield'); ?>
            <?php echo eduform_checkbox_group('role_ids', 'Pilih Role', $roles, $user_role_ids); ?>
        <?php echo educard_end(); ?>
    </div>
</div>
<?php echo form_close(); ?>
